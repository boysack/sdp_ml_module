...
class Encoder(nn.Module):
    ...
    def forward(self, x):
        ...
        # hidden_n is a summary of all the hidden states of the batch
...
class CVAE(pl.LightningModule):
    def __init__(self, seq_len, feat_dim, conditional_dim, enc_out_dim, latent_dim, beta, learning_rate, min_std, checkpoint_path):
        ...
        self.decoder = Decoder(seq_len, feat_dim, latent_dim + conditional_dim, enc_out_dim)
...
class VAE(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        # decoded 
        x_hat, x_log_scale = self.decoder(z)
